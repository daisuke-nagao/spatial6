...
- Phase 4: the independent consumer executes every one of the 16 subsets of
  ...
  feature audits passed for every row. The audit parser's 17 regression tests pass.
...
The independent fixture locks generated by Cargo 1.89 resolve glam 0.33.8,
...
The compatible minor release is 1.3.0. This branch prepares that package version;
it does not publish the crate or create a release tag.
